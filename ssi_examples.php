...
?>
			...
			<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php require(&quot;<?php echo addslashes($user_info['is_admin'] ? realpath($boarddir . '/SSI.php') : 'SSI.php'); ?>&quot;); ?&gt;</code>
...
<!-- RECENT ITEMS -->
			<div class="ssi_preview" id="ssi_recentTopics">
				...
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_recentTopics(); ?&gt;</code>
				<h3>Code (advanced mode)</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_recentTopics($num_recent = 8, $exclude_boards = null, $include_boards = null, $output_method = 'echo'); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_recentPosts">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_recentPoll(); ?&gt;</code>
				<h3>Result</h3>
...
<!-- TOP ITEMS -->
			<div class="ssi_preview" id="ssi_topBoards">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_topBoards(); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_topTopicsViews">
				...
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_topTopicsViews(); ?&gt;</code>
				<h3>Result</h3>
				<div class="ssi_result"><?php ssi_topTopicsViews(); flush(); ?></div>

				<h3>Code (show by number of replies)</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_topTopicsReplies(); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_topPoll">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_topPoll(); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_topPoster">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_topPoster(); ?&gt;</code>
				<h3>Result</h3>
...
<!-- MEMBERS -->
			<div class="ssi_preview" id="ssi_latestMember">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_latestMember(); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_randomMember">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_randomMember('day'); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_whosOnline">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_whosOnline(); ?&gt;</code>
				<h3>Result</h3>
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_logOnline(); ?&gt;</code>
				<h3>Result</h3>
...
<!-- WELCOME, LOGIN AND LOGOUT -->
			<div class="ssi_preview" id="ssi_login">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_login(); ?&gt;</code>
				<h3>Result</h3>
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_logout(); ?&gt;</code>
				<h3>Result</h3>
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_welcome(); ?&gt;</code>
				<h3>Result</h3>
...
<!-- CALENDAR -->
			<div class="ssi_preview" id="ssi_todaysCalendar">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_todaysCalendar(); ?&gt;</code>
				<h3>Result</h3>
				<div class="ssi_result"><?php ssi_todaysCalendar(); flush(); ?></div>

				<h2>Today's Birthdays Function</h2>
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_todaysBirthdays(); ?&gt;</code>
				<h3>Result</h3>
				<div class="ssi_result"><?php ssi_todaysBirthdays(); flush(); ?></div>

				<h2>Today's Holidays Function</h2>
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_todaysHolidays(); ?&gt;</code>
				<h3>Result</h3>
				<div class="ssi_result"><?php ssi_todaysHolidays(); flush(); ?></div>

				<h2>Today's Events Function</h2>
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_todaysEvents(); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_recentEvents">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_recentEvents(); ?&gt;</code>
				<h3>Result</h3>
...
<!-- MISCELLANEOUS -->
			<div class="ssi_preview" id="ssi_boardStats">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_boardStats(); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_news">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_news(); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_boardNews">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_boardNews(); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_menubar">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_menubar(); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_quickSearch">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_quickSearch(); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_recentAttachments">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_recentAttachments(); ?&gt;</code>
				<h3>Result</h3>
...
<!-- ADVANCED FUNCTIONS -->
			<div class="ssi_preview" id="ssi_showPoll">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_showPoll($topicID); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_fetchPosts">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_fetchPosts($postIDs, $isOverride); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_fetchMember">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_fetchMember($memberIDs); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_fetchGroupMembers">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_fetchGroupMembers($groupIDs); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="htmlhome">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return pmxSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code"><?php echo htmlspecialchars(template_homepage_sample1('source')); ?></code>
				<h3>Result</h3>
...
function template_ssi_below()
{
	echo '
			...
			<div id="footer">
				...
				<ul>
					<li class="copyright">
						<span class="smalltext"><a href="http://portamx.com">PortaMx Forum</a></span>
					</li>
				</ul>
			</div>
	</body>
