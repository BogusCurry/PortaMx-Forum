...
//		jsCookieHandling();    
	...
	// Check ECL settings
	if(!empty($modSettings['ecl_enabled']) && !checkECL_Cookie() && empty($_SESSION['session_value']))
	{
		// login from javascript?
		$scriptAct = isset($_REQUEST['action']) && $_REQUEST['action'] == 'login';
