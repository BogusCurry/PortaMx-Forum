...
function Credits($in_admin = false)
{
	...
	$context['credits'] = array(
		array(
			...
			'groups' => array(
				...
				array(
					'title' => $txt['credits_groups_portamx'],
					'members' => array(
						'Korinna "Feline" Kohler',
					),
				),
				array(
	...
	$context['credits_software_graphics'] = array(
		...
		'software' => array(
			...
			'<a href="https://github.com/lokesh/lightbox2">Lightbox2</a> | &copy; Lokesh Dhakar | Licensed under <a href="http://en.wikipedia.org/wiki/MIT_License">The MIT License (MIT)</a>',
		),
		'fonts' => array(
