...
function DisplayAdminFile()
{
	...
	if (strpos($file_data, ';sesc=') !== false && $filetype == 'text/javascript')
		$file_data = '
if (!(\'pmxForum_sessionvar\' in window))
	window.pmxForum_sessionvar = \'sesc\';
' . strtr($file_data, array(';sesc=' => ';\' + window.pmxForum_sessionvar + \'='));
...
function AdminSearchInternal()
{
	...
	$language_files = array(
		'Help', 'Tools', 'ManageMail', 'ManageSettings', 'ManageCalendar', 'ManageBoards', 'ManagePaid', 'ManagePermissions', 'Search',
