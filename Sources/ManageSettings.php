...
function loadGeneralSettingParameters($subActions = array(), $defaultAction = '')
{
	...
	loadLanguage('Help+ManageSettings+Tools+ToolsHelp');
...
function ModifyBasicSettings($return_config = false)
{
	...
	$config_vars = array(
			// Big Options... ecl, polls, sticky, bbc....
			array('check', 'ecl_enabled'),
			array('check', 'ecl_nomodal'),
			array('check', 'ecl_nomodal_mobile'),
			array('int', 'ecl_topofs', 'step' => 1, 'min' => 0, 'max' => 999),
		'',
...
function ModifyLogSettings($return_config = false)
{
	...
	$config_vars = array(
		...
		'',
			...
			// Mod Developers: Do NOT use the pruningOptions master variable for this as PMX Core may overwrite your setting in the future!
	);
