...
function template_main()
{
	...
	echo '
	<div id="edit_poll">
		<form action="' . $scripturl . '?action=editpoll2', $context['is_edit'] ? '' : ';add', ';topic=' . $context['current_topic'] . '.' . $context['start'] . '" method="post" accept-charset="', $context['character_set'], '" onsubmit="submitonce(this); pmxc_saveEntities(\'postmodify\', [\'question\'], \'options-\');" name="postmodify" id="postmodify">
			<div class="cat_bar">
	...
	echo '
					<div class="padding flow_auto">
						<input type="button" value="'. $txt['modify_cancel'] .'" name="'. $txt['modify_cancel'] .'" onclick="window.location.href=\'', $_SERVER['HTTP_REFERER'] .'#top' ,'\'" class="button_submit">
