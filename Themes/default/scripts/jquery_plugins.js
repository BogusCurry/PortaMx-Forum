/**
 * PMXtooltip, Basic JQuery function to provide styled tooltips
 *
...
(function($) {
	$.fn.PMXtooltip = function(oInstanceSettings) {
		$.fn.PMXtooltip.oDefaultsSettings = {
			followMouse: 1,
		...
		var oSettings = $.extend({}, $.fn.PMXtooltip.oDefaultsSettings , oInstanceSettings || {});
