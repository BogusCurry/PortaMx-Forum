...
function template_set_password()
{
		...
		<div class="tborder login">
			...
			<div class="roundframe">
				<dl>
					...
					<dd>
						<input type="password" name="passwrd1" id="pmx_autov_pwmain" size="22" class="input_password">
					...
					<dd>
						<input type="password" name="passwrd2" id="pmx_autov_pwverify" size="22" class="input_password">
						<span id="pmx_autov_pwverify_div" style="display: none;">
							<span id="pmx_autov_pwverify_img" class="generic_icons invalid"></span>
						</span>
					</dd>
				</dl>
	...
	var verificationHandle = new pmxRegister("reminder_form", ', empty($modSettings['password_strength']) ? 0 : $modSettings['password_strength'], ', regTextStrings);
</script>';
}
...
<script>
	...
	var verificationHandle = new pmxRegister("creator", ', empty($modSettings['password_strength']) ? 0 : $modSettings['password_strength'], ', regTextStrings);
</script>';
