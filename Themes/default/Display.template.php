						...
						var oQuickModify = new QuickModify({
							...
							sTemplateBodyEdit: ', JavaScriptEscape('
								<div id="quick_edit_body_container">
									...
									<div class="righttext" style="margin-bottom:5px;">
			...
			if ($attachment['is_image'])
			{
				echo '
										<div class="attachments_top">'. (isset($context['lbimage_data']['lightbox_id']) ? '
											<a class="lb-link" href="' . $attachment['href'] . ';image" title="'. $txt['lightbox_expand'] .'" data-lightbox="' . $context['lbimage_data']['lightbox_id'] . '" data-title="' . $attachment['name'] . '">' : '');
