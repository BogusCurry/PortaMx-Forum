...
function template_select()
{
	...
	<script>
		...
		function select(direction, msg_id)
		{
			...
			{
				getXMLDocument(pmx_prepareScriptUrl(pmx_scripturl) + "action=splittopics;sa=selectTopics;subname=', $context['topic']['subject'], ';topic=', $context['topic']['id'], '." + start[0] + ";start2=" + start[1] + ";move=" + direction + ";msg=" + msg_id + ";xml", onDocReceived);
				return false;
			}
			else
				return true;
