...
$txt['shortcuts_drafts'] = 'shortcuts: alt+s submit/post, alt+p preview, alt+d save draft';
$txt['shortcuts_firefox'] = 'shortcuts: shift+alt+s submit/post, shift+alt+p preview';
$txt['shortcuts_drafts_firefox'] = 'shortcuts: shift+alt+s submit/post, shift+alt+p preview, shift+alt+d save draft';
$txt['option'] = 'Option';
