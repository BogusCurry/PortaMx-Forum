...
$txt['default_default_smileyset_name'] = 'Default Set';
...
$txt['install_settings_info'] = 'This page requires you to define a few key settings for your forum. PortaMx Forum has automatically detected key settings for you.';
...
$txt['db_settings_type_info'] = 'Multiple supported database types were detected - which do you wish to use. Please note that running pre-PortaMx Forum 2.0 RC3 along with newer PortaMx Forum versions in the same PostgreSQL database is not supported. You need to upgrade your older installations in that case.';
...
$txt['db_settings_database_info'] = 'Fill in the name of the database you want to use for PortaMx Forum to store its data in.';
...
$txt['db_settings_database_file_info'] = 'This is the name of the file in which to store the PortaMx Forum data. We recommend you use the randomly generated name for this and set the path of this file to be outside of the public area of your webserver.';
...
$txt['user_settings_server_email_info'] = 'Provide <strong>the email address that PortaMx Forum will use to send emails</strong>. This must be a valid email address!';
...
$txt['error_windows_chmod'] = 'You\'re on a windows server, and some crucial files are not writable. Please ask your host to give <strong>write permissions</strong> to the user PHP is running under for the files in your PortaMx Forum installation. The following files or directories need to be writable:';
...
$txt['error_db_too_low'] = 'The version of your database server is very old, and does not meet PortaMx Forum\'s minimum requirements.<br><br>Please ask your host to either upgrade it or supply a new one, and if they won\'t, please try a different host.';
$txt['error_db_database'] = 'The installer was unable to access the &quot;<em>%1$s</em>&quot; database. With some hosts, you have to create the database in your administration panel before PortaMx Forum can use it. Some also add prefixes - like your username - to your database names.';
...
$txt['error_db_alter_priv'] = 'The database account you specified does not have permission to ALTER, CREATE, and/or DROP tables in the database; this is necessary for PortaMx Forum to function properly.';
$txt['error_versions_do_not_match'] = 'The installer has detected another version of PortaMx Forum already installed with the specified information. If you are trying to upgrade, you should use the upgrader, not the installer.<br><br>Otherwise, you may wish to use different information, or create a backup and then delete the data currently in the database.';
$txt['error_mod_security'] = 'The installer has detected the mod_security module is installed on your web server. Mod_security will block submitted forms even before PortaMx Forum gets a say in anything. PortaMx Forum has a built-in security scanner that will work more effectively than mod_security and that won\'t block submitted forms.<br><br><a href="http://www.simplemachines.org/redirect/mod_security">More information about disabling mod_security</a>';
...
$txt['upgrade_upgrade_utility'] = 'PortaMx Forum Upgrade Utility';
