...
$txt['admin_smffile'] = 'PortaMx File';
$txt['admin_smfpackage'] = 'PortaMx Package';
...
$txt['version_check_desc'] = 'This shows you the versions of your installation\'s files versus those of the latest version. If any of these files are out of date, you should download and upgrade to the latest version at <a href="http://portamx.com/" target="_blank" class="new_win">portamx.com</a>.';
$txt['version_check_more'] = '(more detailed)';

$txt['lfyi'] = 'You are unable to connect to portamx.com\'s latest news file.';
...
$txt['maintain_tasks_desc'] = 'Manage all the tasks scheduled by PortaMx Forum.';
...
$txt['support_versions_forum'] = 'Your version';
...
$txt['attachments_normal'] = '(Manual) PortaMx Forum default behavior';
...
$txt['update_message'] = 'You\'re using an outdated version of PortaMx Forum, which contains some bugs which have since been fixed.
...
$txt['language_description'] = 'This section allows you to edit languages installed on your forum, download new ones from the PortaMx website. You may also edit language-related settings here.';
