<?php
// Version: 2.1 Beta 5; ManageScheduledTasks
...
$txt['scheduled_tasks_time_offset'] = '<strong>Note:</strong> All times given below are <em>server time</em> and do not take any time offsets setup within PortaMx Forum into account.';
...
$txt['scheduled_task_fetchPMXfiles'] = 'Fetch PortaMx-Forum Files';
$txt['scheduled_task_desc_fetchPMXfiles'] = 'Retrieves javascript files containing notifications of updates and other information.';
