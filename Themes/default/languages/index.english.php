...
$txt['last_edit_by'] = '<span class="lastedit"><b>Last Edit</b></span>: %1$s by %2$s';
$txt['last_edit_reason'] = '<span class="lastedit"><b>Reason</b></span>: %1$s';
...
$txt['line'] = 'Line';
// Use numeric entities in the below string.
$txt['tried_to_repair'] = 'PortaMx Forum has detected and automatically tried to repair an error in your database. If you continue to have problems, or continue to receive these emails, please contact your host.';
...
$txt['not_removed_extra'] = '%1$s is a backup of %2$s that was not generated by PortaMx Forum. It can be accessed directly and used to gain unauthorized access to your forum. You should delete it immediately.';
