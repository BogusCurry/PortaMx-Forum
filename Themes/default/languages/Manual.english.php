...
$txt['manual_pmx_user_help'] = 'User Help';

$txt['manual_welcome'] = 'Welcome to %s, powered by PortaMx/Simple Machines&reg; Forum software!';
$txt['manual_introduction'] = 'PortaMx Forum&reg; is the elegant, effective, powerful and free forum software solution that this site is running. It allows users to communicate in discussion topics on a given subject in a clever and organized manner. Furthermore, it has a number of powerful features which end users can take advantage of. Help for many of PortaMx Forum\'s features can be found by either clicking the question mark icon next to the relevant section or by selecting one of the links on this page. These links will take you to PortaMx Forum\'s centrally-located documentation on the Simple Machines official site.';
$txt['manual_docs_and_credits'] = 'For more information about how to use PortaMx Forum, please see the <a href="%1$s" target="_blank" class="new_win">Simple Machines Documentation Wiki</a> and check out the <a href="%2$s">credits</a> to find out who has made PortaMx Forum what it is today.';
...
$txt['manual_section_features_desc'] = 'Here is a list of the most popular features in PortaMx Forum.';
