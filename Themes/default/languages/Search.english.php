...
$txt['search_create_index_not_ready'] = 'PortaMx Forum is currently creating a search index of your messages. To avoid overloading your server, the process has been temporarily paused. It should automatically continue in a few seconds. If it doesn\'t, please click continue below.';
...
$txt['spider_mode_note'] = 'Note that logging of every spider action only occurs if tracking is set to either "Moderate" or "Aggressive". Detail of every spiders action is only logged if tracking is set to "Aggressive".';
